...
NJ returned trees with reasonable ages, but trees are way non ultrametric, as you can see in `r fig_lttplot_sdm`
and `r fig_lttplot_median`.

```{r make-lttplot-summ3-test, echo = F, results = 'asis', fig.cap= ""}
figcap_lttplot_cluster <- paste("Lineage Through Time plots of", taxon, "summary
chronograms from median (upper) and SDM (lower) summary matrices obtained with various clustering algorithms.")
