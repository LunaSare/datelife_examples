...
figcap_lttplot_summchrono <- paste(taxon, "lineage through time (LTT) plots from source chronograms and
    SDM and median summary matrix converted to phylo with `datelife` algorithm.")
