...
figcap_make_lttplot_summ2 <- paste("Lineage Through Time plots of", taxa, "summary chronograms obtained from median (orange) and SDM (purple) summary matrices, clustered using NJ (dashed lines) and UPGMA (solid line) algorithms.")
