...
![Lineage Through Time plots of Anolis summary
chronograms from median (upper) and SDM (lower) summary matrices obtained with various clustering algorithms.](plots/Anolis_make_lttplot_summ3_test_median.pdf)
