...
-->
A tree with branch lengths could be constructed for 6 source chronograms (out of 6) available for the Anolis.
...
\caption{\label{tab:unnamed-chunk-5}Anolis source chronogram studies information.}\\
\toprule
