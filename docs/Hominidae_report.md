...
There are 7 species in the taxon Hominidae, following the NCBI taxonomy database.
...
In the case of the  Hominidae  all source chronograms have at least two overlapping species.
...
-->
A tree with branch lengths could be constructed for 8 source chronograms (out of 8) available for the Hominidae. To date these
...
\caption{\label{tab:source_chr}Hominidae source chronogram original studies information.}\\
\toprule
...
\begin{figure}[!h]
\includegraphics{plots/Hominidae_LTTplot_phyloall.pdf}
\caption{Lineage through time (LTT) plots of source chronograms
  available in database for species in the Hominidae. Numbers correspond to original
...
\begin{figure}[!h]
\includegraphics{plots/Hominidae_lttplot_cluster_median.pdf}
\caption{Lineage Through Time plots of Hominidae median summary
...
\begin{figure}[!h]
\includegraphics{plots/Hominidae_LTTplot_summary_chronograms2.pdf}
\caption{Hominidae lineage through time (LTT) plots of summary chronograms
...
\begin{figure}[!h]
\includegraphics{plots/Hominidae_LTTplot_crossval_bladj.pdf}
\caption{Hominidae lineage through time (LTT) plots from
...
\begin{figure}[!h]
\includegraphics{plots/Hominidae_lttplot_cluster_sdm.pdf}
\caption{Lineage Through Time plots of Hominidae SDM summary
chronograms obtained with different clustering algorithms. Not all algorithms worked
