...
There are 7 subspecies in the Open Tree of Life Taxonomy for the taxon Hominidae.
...
Unfortunately, a tree with branch lengths could not be
    constructed for any of the source chronograms available for the Hominidae, so this workflow will not be exemplified here. This can happen for several
...
\caption{\label{tab:unnamed-chunk-6}Hominidae source chronogram studies information.}\\
\toprule
...
\begin{figure}[h!]
  ...
  for species in the Hominidae. Numbers correspond to original studies in Table 1. Arrows indicate maximum age of each chronogram.}
...
\begin{figure}[h!]
	\includegraphics{plots/Hominidae_LTTplot_summary_chronograms.pdf}
...
Dated induced subtree could not be obtained for the Hominidae.
