...
![Lineage through time (LTT) plots of source chronograms available in data base
  for species in the Hominidae. Numbers correspond to original studies in Table 1. Arrows indicate maximum age of chronograms.](plots/Hominidae_LTTplot_phyloall.pdf)
