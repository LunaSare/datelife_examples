...
-->
A tree with branch lengths could be constructed for 8 source chronograms (out of 8) available for the Primates.
...
\caption{\label{tab:unnamed-chunk-5}Primates source chronogram studies information.}\\
\toprule
