...
chronograms from median (upper) and SDM (lower) summary matrices obtained with various clustering algorithms.](plots/Spheniscidae_lttplot_cluster_median.pdf)
