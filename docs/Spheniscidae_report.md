...
-->
A tree with branch lengths could be constructed for 13 source chronograms (out of 13) available for the Spheniscidae.
...
\caption{\label{tab:unnamed-chunk-5}Spheniscidae source chronogram studies information.}\\
\toprule
