plan_data2 <- drake_plan(
  ...
  # tax_othercalall[[1]][1]
  crossval1all = mapply(use_othercals1, tax_phyloallall, tax_othercalall),
  crossval2all = mapply(use_othercals2, tax_phyloallall, tax_othercalall),
  crossval3all = mapply(use_othercals3, tax_phyloallall, tax_othercalall),
